    ...
    <div class="sidebar-nav">
        ...
        <ul class="metismenu" id="sidenav">
          <li>
            ...
            <ul>
              <li><a href="{{route('metricas')}}" class="load-content"><i class="material-icons-outlined">arrow_right</i>Analysis</a>
              </li>
              <li><a href="{{route('usuario.index')}}" class="load-content"><i class="material-icons-outlined">arrow_right</i>eCommerce</a>
              </li>
            </ul>
          </li>
          <li>
